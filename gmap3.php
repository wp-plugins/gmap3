...
function rw_gmap3_init() {
		...
		wp_register_script('googlemapsapi3', 'http://maps.google.com/maps/api/js?sensor=false', false, '3'); 
		wp_enqueue_script('googlemapsapi3');
		// gmap itself
		wp_deregister_script('gmap3');
		wp_register_script('gmap3', plugins_url('/js/gmap3.min.js',__FILE__), array('jquery'), '3.4'); 
